...
CREATE TABLE unidade_responsavel (
	...
	disciplina CodigoDisciplina NOT NULL,
	cidade CHAR(15) NOT NULL,
	PRIMARY KEY (id),
	FOREIGN KEY (disciplina) REFERENCES disciplina(codigo)
);

CREATE INDEX disciplinax_unidade ON unidade_responsavel(disciplina);
...
GRANT SELECT ON ALL TABLES IN SCHEMA public TO kd_user;
